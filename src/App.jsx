...
import "./App.css";
import alhancodeboi from "../alhancodeboi/build/main.aleo?raw";
...
function App() {
  ...
  async function deploy() {
    setDeploying(true);
    try {
      const result = await aleoWorker.deployProgram(alhancodeboi);
